#### منطق رنگ آمیزی ستون sub-prptocols باز نویسی شد و دقیق تر شد! (تغییرات فقط برای نسخه 12+ اعمال شد!)

### نسخه مناسب Wallix Bastion 9.x اضافه شد!
...
### Version for Wallix Bastion 9.x added!
